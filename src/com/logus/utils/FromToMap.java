...
public class FromToMap {
	...
	public static Map<String, String> init() {
		...
		depara.get().put("PRODESENVOLVIMENTO III", "PRODESENVOLVIMENTO III");
		depara.get().put("PRODETUR II", "PRODETUR II");
		depara.get().put("BNDES - PEF II", "PEF II");
		depara.get().put("PROINVEST", "PROINVEST");
		depara.get().put("PARC. L 11941-EMGERPI-PREV", "PARC L 11941-EMGERPI-PREV");
		depara.get().put("PARC. L 11941 EMGERPI-OUTR", "PARC L 11941 EMGERPI-OUTR");
		depara.get().put("PARC. INSS LEI 12810-EXEC", "PARC. INSS LEI 12810-EXEC");
		depara.get().put("PARC. INSS LEI12810-LEGISL", "PARC INSS LEI12810-LEGISL");
		depara.get().put("PARC. INSS LEI 12810 MP", "PARC INSS LEI 12810 MP");
		depara.get().put("PARC. INSS SIMPL ORD EDUCAÇÃO", "INSS SIMPL ORD EDUCAÇÃO");
		depara.get().put("PARC. INSS SESAPI", "PARCELAMENTO INSS SESAPI");
		depara.get().put("PARC. PASEP LEI 12.810/13", "PARC PASEP LEI 12.810/13");
		depara.get().put("PARC. EMGERPI LEI 12996 PR", "PARC EMGERPI LEI 12996 PR");
		depara.get().put("PARC. EMGERPI LEI12996 TR", "PARC. EMGERPI LEI12996 TR");
		depara.get().put("PARC. SIMPL FGTS EMGERPI", "PARC SIMPL FGTS EMGERPI");
		depara.get().put("PARC. EMGERPI ITR/PERT", "PARCEL. EMGERPI ITR/PERT");
		depara.get().put("PARC. PERT ASSEMBLÉIA SENADO", "PERT ASSEMBLÉIA SENADO");
		depara.get().put("PARC. ORD/SIMPLIF. INSS E", "PARC. ORD/SIMPLIF. INSS E");
		depara.get().put("PARC. SIMPLIF INSS", "PARCELAMENTO SIMPLIF INSS");
